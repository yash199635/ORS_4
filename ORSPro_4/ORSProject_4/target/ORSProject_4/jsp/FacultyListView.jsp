...
<jsp:useBean id="colbean" class="in.co.rays.ors.bean.CollegeBean" scope="request"></jsp:useBean>
<jsp:useBean id="corbean" class="in.co.rays.ors.bean.CourseBean" scope="request"></jsp:useBean>
