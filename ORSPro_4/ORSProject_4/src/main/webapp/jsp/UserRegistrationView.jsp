  ...
  <%--                  
   <% System.out.println("=============)))))"+bean.getFirstName());%>  --%>
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" placeholder="Enter valid Email-Id" size="25" value="<%=DataUtility.getStringData(bean.getLogin())%>"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" id="udate" readonly="readonly" size="25" placeholder="Enter Dob "  value="<%=DataUtility.getDateString(bean.getDob())%>"></td> 
